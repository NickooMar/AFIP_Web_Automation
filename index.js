...
async function homePage(page) {
  const billing_qty = 20
  counter += 1

  const elementHandle = await page.$("#novolveramostrar")
  if (elementHandle !== null) {
    await page.click("#novolveramostrar")
  }
  ...
  // Quantity of billings i want to do
  if (counter <= billing_qty) {
